// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FilterChain.cs" company="CyanCor GmbH">
...
namespace ReSpekter
{
    ...
    /// </typeparam>
    public class FilterChain<T> : ICollection<IFilter<T>>, IFilter<T>
    {
        /// <summary>
        /// The list holding all filters.
        /// </summary>
        private readonly List<IFilter<T>> _chain = new List<IFilter<T>>();
        ...
        bool ICollection<IFilter<T>>.IsReadOnly
        {
            get
            {
